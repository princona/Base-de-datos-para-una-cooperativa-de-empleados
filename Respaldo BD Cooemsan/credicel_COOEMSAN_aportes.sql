...
CREATE TABLE `aportes` (
  ...
  `valor_aporte` varchar(45) DEFAULT NULL,
  `fecha_aporte` date DEFAULT NULL,
  `id_cliente` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_aporte`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf32 COLLATE=utf32_spanish2_ci COMMENT='Tabla para registro de aportes de asociados a la coperativa';
...
INSERT INTO `aportes` VALUES (2,'50000','2024-09-30',1),(3,'35000','2024-09-30',2),(4,'60000','2024-09-30',3);
...
-- Dump completed on 2024-09-30 21:07:47
